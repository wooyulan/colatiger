...
func NewWire(configuration *config.Configuration, logger *zap.Logger) (*server.App, func(), error) {
	...
	httpServer := server.NewHttpServer(logger, configuration, cors, jwtAuth, authHandler, chatHandler)
